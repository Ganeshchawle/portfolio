...
_Generated: 2026-05-07T16:09:27.105Z_
...
Workspace `mcp.json` _(folder: git -demo)_

- **c:\Users\Ashish Vatare\OneDrive\Documents\git -demo\.vscode\mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\Ashish Vatare\AppData\Roaming\Code\User\mcp.json** — _File missing_
